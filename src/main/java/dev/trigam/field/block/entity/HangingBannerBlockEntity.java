...
public class HangingBannerBlockEntity extends BannerBlockEntity {
    ...
    public HangingBannerBlockEntity( BlockPos pos, BlockState state ) { super( pos, state ); }

    public HangingBannerBlockEntity( BlockPos pos, BlockState state, DyeColor baseColor ) { super( pos, state, baseColor ); }
